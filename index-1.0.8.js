$(document.body).append(`<div class="info-wrap"><span class="image-size" title="指的是图片中包含的像素数量"></span><br>
<span class="image-size" title="指的是图片占据显示屏幕的大小"></span><br>
<mdui-text-field id="image-url-input" clearable variant="filled" label="请粘贴图片链接"></mdui-text-field></div>
...
function imageCenter() {
    const imgHeight = parseInt($container.css('height'))
    const vh = window.innerHeight
    const mr = imgHeight >= vh ? 0 : (vh - imgHeight) / 2
    $container.css('margin', `${mr}px auto`)
}
